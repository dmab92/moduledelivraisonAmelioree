...
{
    'name': 'Inventory Cameroun',
    'version': '1.1',
    'author': "Boris MENI/borimeni2@gmail.com/+237697005649",
    'summary': 'Gerer votre stock oklm',
    'description': "",
    'website': 'https://www.soacam.cm',
    ...
    'data': [
        ...
        'report/report_bordereau_livraison.xml',

        'data/mail_template_data.xml',

        'wizard/wizard_borderau_livraison.xml',
